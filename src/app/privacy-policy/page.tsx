				...
				<div className="prose max-w-none space-y-8">
						...
						<div className="space-y-4">
							<div className="border-l-4 border-pink-500 pl-6">
								...
								<p className="text-gray-600">
									We use your preferences, location, and
									behavior to suggest compatible matches and
							...
							<div className="border-l-4 border-purple-500 pl-6">
								...
								<p className="text-gray-600">
									Your information helps us detect and prevent
									fraud, harassment, and other harmful
									activities.
								</p>
							</div>
							...
							<div className="border-l-4 border-blue-500 pl-6">
								...
								<p className="text-gray-600">
									We facilitate secure messaging between users
					...
					<section>
						...
						<div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
							...
							<p className="text-red-700">
								SeeYou will never sell, rent, or trade your
						...
						<div className="space-y-4">
							...
							<ul className="list-disc pl-6 space-y-2 text-gray-600">
								<li>
									With other users (only information you
									choose to share in your profile)
								</li>
								<li>
								...
								<li>
									When required by law or to protect user
									safety
								</li>
								<li>
					...
					<section>
						...
						<p className="text-gray-600 mb-4">
							We use your location to show you nearby matches and
							relevant local features. You can control location
							sharing in your device settings or app preferences.
						</p>
						<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
							<p className="text-yellow-800">
								<strong>Note:</strong> Disabling location may
								limit some features like nearby matches and
								location-based safety tools.
							</p>
						</div>
					</section>
							...
							<div className="bg-gray-50 p-6 rounded-lg">
								...
								<ul className="space-y-2 text-gray-600">
									<li>
										...
										Information retained while account is
										active
									</li>
									<li>
									...
									<li>
										...
										Some data may be retained longer as
										required by law
									</li>
									<li>
										• <strong>Safety records:</strong>{" "}
										Records of policy violations may be kept
										for safety purposes
									</li>
								</ul>
							</div>
					...
					<section>
						...
						<div className="bg-red-50 border border-red-200 rounded-lg p-6">
							...
							<p className="text-red-700">
								SeeYou is intended for users 18 years and older.
								We do not knowingly collect information from
								anyone under 18. If you believe a user is under
								18, please report them immediately.
							</p>
						</div>
					</section>
					...
					<section>
						...
						<p className="text-gray-600">
							SeeYou operates globally. By using our service, you
							consent to the transfer of your information to
							countries where we operate, which may have different
					...
					<section>
						...
						<p className="text-gray-600">
							...
							the app or by email. Your continued use of SeeYou
							after changes indicates your acceptance of the
							updated policy.
						</p>
					</section>
						...
						<div className="bg-pink-50 border border-pink-200 rounded-lg p-6">
							...
							<div className="space-y-2 text-pink-700">
								<p>
									📧 Email:{" "}
									<a
										href="mailto:privacy@seeyou.com"
										className="underline"
									>
										privacy@seeyou.com
									</a>
